export const projects = [
  { id:1, title:'두산에너빌리티 게스트하우스(보안관계상 link X)', category:'Full Stack', desc:'두산에너빌리티 게스트하우스 예약 및 관리 시스템 풀스택 개발. UIUX 디자인, 퍼블리싱, Report Design 포함.', tags:['Figma','JSP','Java','HTML/CSS','JavaScript'], year:'2025', color:'from-blue-500/20 to-indigo-500/20', accent:'#5B8EFF', client:'㈜두산에너빌리티', period:'2025.06~2025.12', featured:true, link:'https://guesthouse.doosanenerbility.com/' },
  { id:2, title:'두산에너빌리티 CMMS(보안관계상 link X)', category:'Publishing', desc:'설비 유지보수 관리 시스템(CMMS) UIUX 디자인 및 퍼블리싱. Figma 기반 설계 후 웹 구현.', tags:['Figma','HTML/CSS','JavaScript'], year:'2025', color:'from-orange-500/20 to-rose-500/20', accent:'#FF6B6B', client:'㈜두산에너빌리티', period:'2025.06~2025.07', featured:true, link:'https://cmms.doosanenerbility.com/' },
  { id:3, title:'사내 웹 표준 템플릿(보안관계상 link X)', category:'Design System', desc:'한국오픈솔루션 사내 프로젝트 공용 웹 표준 템플릿 설계 및 구축.', tags:['HTML/CSS','JavaScript','JSP','Design System'], year:'2025', color:'from-cyan-500/20 to-teal-500/20', accent:'#06B6D4', client:'㈜한국오픈솔루션', period:'2025.02~2025.05', featured:true, link:'https://standards.hancom.com/' },
